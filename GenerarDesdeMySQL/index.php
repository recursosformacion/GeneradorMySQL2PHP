<!DOCTYPE html>
<!-- https://www.codediesel.com/php/automatically-create-php-classes-from-mysql/-->
<html>
<head>
    <!-- *** METADATA *** -->
	...
	<script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#database").change(function() {
                ...
                console.log('Database='+strDatabase);
                if(strDatabase) {
                ...
                if(strTable) {
                    ...
                    function(data){
                    	 if(data.indexOf("Error:") < 0 && data.indexOf("xdebug-error") < 0) {
                            ...
                            $("#classname").attr("value", strClassname.charAt(0).toUpperCase() + strClassname.slice(1));
